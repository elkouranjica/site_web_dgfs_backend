...
from main.institution.serializers import MinistereSerializer, DirectionSerializer, ServiceSerializer, DirecteurSerializer,\
...
class MinistereViewSet(AbstractViewSet):
	...
	def get_object(self):
		obj = Ministere.objects.get_object_by_public_id(self.kwargs["pk"])
...
class DirectionViewSet(AbstractViewSet):
	...
	def get_object(self):
		obj = Direction.objects.get_object_by_public_id(self.kwargs["pk"])
		self.check_object_permissions(self.request, obj)
		return obj
...
class DirecteurViewSet(AbstractViewSet):
	...
	def get_object(self):
		obj = Directeur.objects.get_object_by_public_id(self.kwargs["pk"])
		self.check_object_permissions(self.request, obj)
		return obj
...
class ChefServiceViewSet(AbstractViewSet):
	...
	def get_object(self):
		obj = ChefService.objects.get_object_by_public_id(self.kwargs["pk"])
		self.check_object_permissions(self.request, obj)
		return obj
